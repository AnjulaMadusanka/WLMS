...
import { Box, DialogActions, DialogContent, Button, Grid, SvgIcon, Checkbox } from "@mui/material";

import { useDispatch } from 'react-redux';
import { useDropzone } from 'react-dropzone';
import _ from "lodash"
import { Actions } from "../../../../core/modules/Actions";
import { getText, IMAGE_URL, setText } from "../../../../core/Constant";
import { TextEditior, TextInputComponent } from "../../../atom";
...
const AdminNewsletterCreate = ({ onClose = () => { }, courseList }) => {
    ...
    const onCreateNewsLetter = () => {
        if (istitleValid) {
            ...
            dipatch(Actions.newsLetter.createNewsletterContent(formData));
            onClose();
            _.delay(() => {
                onReset();
            }, 1000)
    ...
    const onChangeContent = (content, imageFiles, updatedContent) => {
        ...
        if (imageFiles?.length > 0) {
            const updatedImages = _.map(imageFiles, (file) => (
                file));
...
export default AdminNewsletterCreate;